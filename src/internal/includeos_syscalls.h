...
__includeos(SYS_brk);
__includeos(SYS_close);
__includeos(SYS_copy_file_range);
__includeos(SYS_epoll_wait);
__includeos(SYS_execveat);
__includeos(SYS_exit_group);
__includeos(SYS_exit);
__includeos(SYS_fadvise);
__includeos(SYS_fallocate);
__includeos(SYS_fcntl);
__includeos(SYS_flistxattr);
__includeos(SYS_fork);
__includeos(SYS_fremovexattr);
__includeos(SYS_fsetxattr);
__includeos(SYS_futex);
__includeos(SYS_futex_time64);
__includeos(SYS_get_robust_list);
__includeos(SYS_getdents);
__includeos(SYS_getegid);
__includeos(SYS_geteuid);
__includeos(SYS_getgid);
__includeos(SYS_getpid);
__includeos(SYS_getppid);
__includeos(SYS_getrandom);
__includeos(SYS_gettid);
__includeos(SYS_getuid);
__includeos(SYS_inotify_init);
__includeos(SYS_ioctl);
__includeos(SYS_lremovexattr);
__includeos(SYS_membarrier);
__includeos(SYS_memfd_create);
__includeos(SYS_mmap2);
__includeos(SYS_mlock2);
__includeos(SYS_msgctl);
__includeos(SYS_msgget);
__includeos(SYS_munlockall);
__includeos(SYS_name_to_handle_at);
__includeos(SYS_open_by_handle_at);
__includeos(SYS_pause);
__includeos(SYS_poll);
__includeos(SYS_ppoll);
__includeos(SYS_ppoll_time64);
__includeos(SYS_removexattr);
__includeos(SYS_rt_sigqueueinfo);
__includeos(SYS_sched_getaffinity);
__includeos(SYS_sched_yield);
__includeos(SYS_semctl);
__includeos(SYS_semget);
__includeos(SYS_semop);
__includeos(SYS_semtimedop);
__includeos(SYS_semtimedop_time64);
__includeos(SYS_setsid);
__includeos(SYS_set_tid_address);
__includeos(SYS_shmat);
__includeos(SYS_sync);
